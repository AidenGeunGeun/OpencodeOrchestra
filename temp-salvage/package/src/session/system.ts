...
export namespace SystemPrompt {
  export function header(providerID: string, modelID?: string): string[] {
    // Check providerID for direct anthropic, or modelID for Claude through Copilot
    if (providerID.includes("anthropic") || modelID?.includes("claude")) return [CLAUDE_CODE_SPOOF]
    return []
  }
