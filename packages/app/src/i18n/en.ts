export const dict = {
  ...
  "session.tab.secureEnv": "Secure Env",
  ...
  "session.secureEnv.loading": "Loading project keys...",
  "session.secureEnv.header.summary.empty": "No keys yet · auto-injected when added",
  "session.secureEnv.header.summary.one": "1 key · auto-injected into project tools",
  "session.secureEnv.header.summary.other": "{{count}} keys · auto-injected into project tools",
  "session.secureEnv.header.redaction": "Output redacted before models see it",
  "session.secureEnv.header.fallbackProject": "This project",
  "session.secureEnv.empty.body": "Save project keys here so models never see them. Names stay visible; values are masked and auto-injected.",
  "session.secureEnv.action.add": "Add variable",
  "session.secureEnv.action.paste": "Paste from .env",
  "session.secureEnv.action.save": "Save",
  "session.secureEnv.action.edit": "Edit",
  "session.secureEnv.action.delete": "Delete",
  "session.secureEnv.action.reveal": "Show value",
  "session.secureEnv.action.hide": "Hide value",
  "session.secureEnv.action.copy": "Copy value",
  "session.secureEnv.action.more": "More options",
  "session.secureEnv.field.name": "Name",
  "session.secureEnv.field.value": "Value",
  "session.secureEnv.field.valuePlaceholder": "Paste secret value",
  "session.secureEnv.field.replaceValue": "Replace value",
  "session.secureEnv.field.replaceValuePlaceholder": "Leave blank to keep current value",
  "session.secureEnv.field.valueLeaveBlank": "Leave blank to keep the current value",
  "session.secureEnv.error.nameEmpty": "Name is required",
  "session.secureEnv.error.nameInvalid": "Use letters, digits, and underscores. Must not start with a digit.",
  "session.secureEnv.error.valueEmpty": "Value is required",
  "session.secureEnv.error.valueTooShort": "Value needs at least {{min}} characters so it can be masked everywhere",
  "session.secureEnv.error.pasteEmpty": "Paste at least one KEY=value line",
  "session.secureEnv.delete.confirm": "Delete {{name}}?",
  "session.secureEnv.bulk.selectAll": "Select all visible",
  "session.secureEnv.bulk.selectEntry": "Select {{name}}",
  "session.secureEnv.bulk.selected": "{{count}} selected",
  "session.secureEnv.bulk.deleteSelected": "Delete selected",
  "session.secureEnv.bulk.confirmTitle": "Delete {{count}} variables?",
  "session.secureEnv.bulk.more": "+{{count}} more",
  "session.secureEnv.bulk.deleted": "Deleted {{count}} variables.",
  "session.secureEnv.bulk.partial": "Deleted {{deleted}} variables. {{failed}} could not be deleted.",
  "session.secureEnv.paste.title": "Paste from .env",
  "session.secureEnv.paste.description": "One KEY=VALUE per line. Lines under 8 characters are skipped.",
  "session.secureEnv.paste.placeholder": "OPENAI_API_KEY=sk-...\nANTHROPIC_API_KEY=...",
  "session.secureEnv.paste.overwrite": "Overwrite existing keys",
  "session.secureEnv.paste.import": "Import",
  "session.secureEnv.paste.noneImported": "No keys imported. Lines may be empty, malformed, or under 8 characters.",
  "session.secureEnv.paste.importedSummary": "Imported {{count}} keys.",
  "session.secureEnv.risk.low": "Low",
  "session.secureEnv.risk.medium": "Medium",
  "session.secureEnv.risk.high": "High",
  "session.secureEnv.risk.production": "Production",
  "session.secureEnv.risk.selectLabel": "Risk label",
