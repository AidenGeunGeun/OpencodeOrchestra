...
export function TerminalPanel(props: {
  ...
  const [bodyMounted, setBodyMounted] = createSignal(props.open)
  const mountDelay = () => getMotionDuration(MOTION_DURATION_NORMAL_TOKEN, 260)
  ...
  return (
    <div
      ...
      class="relative w-full flex flex-col shrink-0 border-t border-border-weak-base motion-measured-shell"
      classList={{ "motion-measured-shell-hidden": !props.open }}
      style={{
        height: props.open ? `${props.height}px` : "0px",
        opacity: props.open ? 1 : 0,
        "pointer-events": props.open ? "auto" : "none",
        "border-top-width": props.open ? undefined : "0px",
      }}
    >
