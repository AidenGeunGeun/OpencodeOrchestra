export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OpenCodeOrchestra foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do OCO está ausente. Tente reinstalar o aplicativo de desktop.",
