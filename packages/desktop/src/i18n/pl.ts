export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenCodeOrchestra. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'oco'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego OCO CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
