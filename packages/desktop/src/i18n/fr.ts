export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenCodeOrchestra a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'oco'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI OCO est manquant. Essayez de réinstaller l'application de bureau.",
