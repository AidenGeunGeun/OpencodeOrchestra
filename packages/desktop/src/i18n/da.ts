export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenCodeOrchestra er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'oco'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "OCO CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
