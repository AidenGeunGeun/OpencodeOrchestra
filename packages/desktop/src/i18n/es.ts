export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenCodeOrchestra. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de OCO. Intenta reinstalar la aplicación de escritorio.",
