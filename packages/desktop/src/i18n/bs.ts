export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenCodeOrchestra-e",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenCodeOrchestra-e je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'oco'.",
  ...
  "desktop.menu.help.documentation": "OpenCodeOrchestra Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka OCO CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
