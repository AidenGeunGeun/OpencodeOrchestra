export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt": "Версия OpenCodeOrchestra {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'oco'.",
  ...
  "desktop.menu.help.documentation": "Документация OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл OCO CLI. Попробуйте переустановить настольное приложение.",
