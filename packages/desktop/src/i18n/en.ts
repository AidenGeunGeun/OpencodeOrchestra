export const dict = {
  ...
  "desktop.menu.app": "OpenCodeOrchestra",
  ...
  "desktop.menu.help.documentation": "OpenCodeOrchestra Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OpenCodeOrchestra has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'oco' command.",
  ...
  "desktop.cli.error.sidecarMissing": "The bundled OCO CLI binary is missing. Try reinstalling the desktop app.",
