export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの OpenCodeOrchestra を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCodeOrchestra のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "OpenCodeOrchestra ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "OCO CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
