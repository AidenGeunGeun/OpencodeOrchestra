export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من OpenCodeOrchestra، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق OpenCodeOrchestra",
  ...
  "desktop.cli.error.sidecarMissing": "ملف OCO CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
