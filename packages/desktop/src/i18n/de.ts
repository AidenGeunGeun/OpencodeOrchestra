export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenCodeOrchestra wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'oco' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "OpenCodeOrchestra-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das OCO CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
