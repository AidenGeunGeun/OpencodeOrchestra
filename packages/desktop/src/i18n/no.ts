export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenCodeOrchestra",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenCodeOrchestra er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'oco'-kommandoen.",
  ...
  "desktop.menu.help.documentation": "OpenCodeOrchestra Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "OCO CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
