      ...
      Database.use((db) =>
        db
          ...
          .values({
            ...
            project_id: exportData.info.projectID,
            parent_id: exportData.info.parentID,
            slug: exportData.info.slug,
            directory: exportData.info.directory,
            title: exportData.info.title,
            version: exportData.info.version,
            share_url: exportData.info.share?.url,
            summary_additions: exportData.info.summary?.additions,
            summary_deletions: exportData.info.summary?.deletions,
            summary_files: exportData.info.summary?.files,
            summary_diffs: exportData.info.summary?.diffs,
            revert: exportData.info.revert ?? null,
            permission: exportData.info.permission,
            time_created: exportData.info.time.created,
            time_updated: exportData.info.time.updated,
            time_compacting: exportData.info.time.compacting,
            time_archived: exportData.info.time.archived,
          })
          .onConflictDoNothing()
          .run(),
      )
