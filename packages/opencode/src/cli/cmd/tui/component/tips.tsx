...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle between PM and Orchestrator agents",
  ...
  "The {highlight}PM{/highlight} agent handles both planning and building in a unified workflow",
  ...
  "OpenCodeOrchestra auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OpenCodeOrchestra auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OpenCodeOrchestra uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent OpenCodeOrchestra from reading sensitive files",
  "Use {highlight}oco run{/highlight} for non-interactive scripting",
  "Use {highlight}oco --continue{/highlight} to resume the last session",
  "Use {highlight}oco run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}oco serve{/highlight} for headless API access to OpenCodeOrchestra",
  "Use {highlight}oco run --attach{/highlight} to connect to a running server",
  "Run {highlight}oco upgrade{/highlight} to update to the latest version",
  "Run {highlight}oco auth list{/highlight} to see all configured providers",
  "Run {highlight}oco agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}oco github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}oco debug config{/highlight} to troubleshoot configuration",
