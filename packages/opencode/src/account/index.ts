...
import { Account as AccountSchema, type AccountError, type AccessToken, AccountID, AccountService, OrgID } from "./service"
...
export namespace Account {
  ...
  export type Account = import("./schema").Account
