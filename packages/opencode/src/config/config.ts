...
export namespace Config {
  ...
  export const Agent = z
    .object({
      ...
      display_name: z.string().optional().describe("Display label for selectors and UI agent badges"),
      ...
      // OpenCodeOrchestra: Controls single-shot behavior for agent task completion
      single_shot: z
        .boolean()
        .optional()
    ...
    .transform((agent, ctx) => {
      const knownKeys = new Set([
        ...
        "disable",
        "tools",
        "single_shot", // OpenCodeOrchestra: singleShot config key
      ])
  ...
  export const Keybinds = z
    .object({
      ...
      session_child: z.string().optional().default("<leader>down").describe("Go to first child session"),
